      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="block w-full pl-16 pr-4 py-2.5 border border-[var(--border)] rounded-[999px] focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent text-sm placeholder:text-[var(--muted-text)] h-11 leading-[44px] transition-all duration-200 hover:bg-[var(--hover)] bg-[var(--background)]"
          />
          {searchQuery && (
            <button
