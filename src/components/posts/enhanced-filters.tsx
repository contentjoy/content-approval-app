    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 relative">
          <div className="absolute inset-y-0 left-0 w-12 flex items-center justify-center pointer-events-none select-none">
          ...
          <input
            ...
            className="block w-full pl-12 pr-4 py-2.5 border border-border rounded-full focus:ring-2 focus:ring-accent focus:border-transparent text-sm placeholder:text-muted-text bg-bg h-11 leading-[44px]"
          />
          {searchQuery && (
            <button
