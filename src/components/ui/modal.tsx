      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className={`w-full h-full sm:h-auto ${sizeClasses[size]} sm:max-h-[90vh] bg-[var(--modal-surface)] border border-[var(--modal-border)] rounded-none sm:rounded-[12px] overflow-hidden shadow-xl`}
            role="dialog"
            aria-modal="true"
